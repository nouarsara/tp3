...
public class RecepteurMulticast2 {

	 public static void main(String[] args) throws IOException {
	        // Crée un objet MulticastSocket pour recevoir les datagrammes multicast
	        MulticastSocket multicastSocket = new MulticastSocket(12367);
	        ...
	        FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\wakcomputer\\Desktop\\tous\\recepteur2\\tp3 reseau.txt");
